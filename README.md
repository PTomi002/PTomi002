...
### 🏗️ System Design
> design patterns, problems by topics, tradeoffs

- [System Design Problems](https://github.com/PTomi002/fork-system-design)
...
### 🏗️ Infrastructure
> iac, terraform, aws lambda, aws networking, helm, argocd, kargo, minikube
...
- [Udemy - Couchbase Basics](https://github.com/PTomi002/course-couchbase)
...
- [Data Handler - Eureka Server](https://github.com/PTomi002/microservice-eureka)
- [Data Handler - Application](https://github.com/PTomi002/microservice-data-handler-service)
- [Data Handler - Redis](https://github.com/PTomi002/microservice-data-handler)

</td>
<td width="50%" valign="top">

### 🤖 Generative AI
> python, neural network, classification, gradient, ai framework
...
### 🎯 Kotlin and Java
> kotlin features, java concurrency, nio, microbenchmark, design patterns
...
### ⚛️ React UI
> npm, ionic, ios and web

- [Body That Speaks](https://github.com/PTomi002/body-that-speaks-ui)
...
### 💼 Interview Tasks
> jms, h2 triggers, postman, hackerrank, system design

- [Action Monitor](https://github.com/PTomi002/interview-action-monitor)
- [Hackerrank Solutions](https://github.com/PTomi002/hackerrank)
- [Design TinyURL](https://github.com/PTomi002/interview-tesco)
...
> Collection of learning materials and reference documentation

- [Software Design & Architecture Roadmap](https://roadmap.sh/software-design-architecture)
- [Monorepo Reference](https://monorepo.tools)
